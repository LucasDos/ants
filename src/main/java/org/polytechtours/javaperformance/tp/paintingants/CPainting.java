...
public class CPainting extends Canvas implements MouseListener {
  ...
  // couleur du fond
  private int mCouleurFond = 0xFFFFFF;
  // dimensions
...
//  }
   ...
   * couleurs
   ******************************************************************************/
  public void setCouleur(int x, int y, int rgb, int pTaille) {
    int i, j, k, l, m, n;
    float R, G, B;
            ...
            for (j = 0; j < 3; j++) {
              ...
              for (k = 0; k < 3; k++) {
                for (l = 0; l < 3; l++) {
                  ...
                  R += (CPainting.mMatriceConv9[k][l] / 16f) * CColor.getRed(mCouleurs[m][n]);
                  G += (CPainting.mMatriceConv9[k][l] / 16f) * CColor.getGreen(mCouleurs[m][n]);
                  B += (CPainting.mMatriceConv9[k][l] / 16f) * CColor.getBlue(mCouleurs[m][n]);
...
//                  B += CPainting.mMatriceConv9[k][l] * mCouleurs[m][n].getBlue();
              ...
              mCouleurs[m][n] = CColor.getRGB((int)R, (int)G, (int)B);
              mGraphics.setColor(new Color(mCouleurs[m][n]));
            ...
            for (j = 0; j < 5; j++) {
              ...
              for (k = 0; k < 5; k++) {
                for (l = 0; l < 5; l++) {
                  ...
                  R += (CPainting.mMatriceConv9[k][l] / 44f) * CColor.getRed(mCouleurs[m][n]);
                  G += (CPainting.mMatriceConv9[k][l] / 44f) * CColor.getGreen(mCouleurs[m][n]);
                  B += (CPainting.mMatriceConv9[k][l] / 44f) * CColor.getBlue(mCouleurs[m][n]);
                }
              }
            ...
            for (j = 0; j < 7; j++) {
              ...
              for (k = 0; k < 7; k++) {
                for (l = 0; l < 7; l++) {
                  ...
                  R += (CPainting.mMatriceConv9[k][l] / 128f) * CColor.getRed(mCouleurs[m][n]);
                  G += (CPainting.mMatriceConv9[k][l] / 128f) * CColor.getGreen(mCouleurs[m][n]);
                  B += (CPainting.mMatriceConv9[k][l] / 128f) * CColor.getBlue(mCouleurs[m][n]);
                }
              }
